            ...
            <?php
               ...
               <div class="col-md-4" >
                    <form method="post" action="NewDish.php?action=add&id=<?php echo $row["D_ID"]; ?>&R_ID=<?php echo $rid; ?>" >
                         ...
                         <img alt = "img1" src="data:unnamed.jpg;charset=utf8;base64,<?php echo base64_encode($row['D_Image']); ?>" style = "height:20vh;width:20vh;"/>
               ...
               <div class="col-md-4">
                    <form method="post" action="NewDish.php?action=add&idd=<?php echo $row["DD_ID"]; ?>&R_ID=<?php echo $rid; ?>">
                         <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">
                         <img alt = "img1" src="data:unnamed.jpg;charset=utf8;base64,<?php echo base64_encode($row['DD_Image']); ?>" style = "height:20vh;width:20vh;"/>
